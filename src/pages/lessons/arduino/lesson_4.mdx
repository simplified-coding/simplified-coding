...
Τα περισσότερα κουμπιά έχουν 4 ποδαράκια. Το ένα ποδαράκι συνδέετε με την γείωση (GND) και τα υπόλοιπα συνδέωνται με τις συσκευές που θέλουμε να συνδεθούν. Συνήθως χρησιμοποιούμε μόνο 1 προς τα digital pins του Arduino.
...
Αυτές οι οθόνες χρησιμοποιούν την τεχνολογία Liquid Crystal Display (LCD) και μπορούμε να τις βρούμε σκέτες ή μαζι με το πρωτόκολλο i2c το οποίο μας επιτρέπει να συνδέσουμε αντί για 16 pins, 4 (power, GND, 2 analog pins (SDA και SCL)).
...
Για να μπορέσουμε να χρησιμοποιήσουμε την οθόνη θα πρέπει να κατεβάσουμε μια βιβλιοθήκη. Αυτη είναι η [LiquidCrystal I2C](https://grobotronics.com/arduino-uno-rev3.html).
...
- Συνδέουμε την γείωση (GND) της οθόνης στην αντίστοιχη σειρά στο breadboard.
- Συνδέουμε την τροφοδοσία της οθόνης (VCC) στην αντίστοιχη σειρά στο breadboard (5V).
- Συνδέουμε το SDA της οθόνης στην θύρα Α4.
- Συνδέουμε το SCL της οθόνης στην θύρα Α5.
