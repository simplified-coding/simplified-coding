...
Το ένα ποδαράκι συνδέετε με την γείωση (GND) και τα υπόλοιπα συνδέονται με τις συσκευές που θέλουμε να συνδεθούν. 
...
Αυτές οι οθόνες χρησιμοποιούν την τεχνολογία Liquid Crystal Display (LCD) και μπορούμε να τις βρούμε σκέτες ή μαζι με το πρωτόκολλο I2C το οποίο μας επιτρέπει να συνδέσουμε αντί για 16 pins, 
4 (VCC (5V), GND, 2 analog pins (SDA και SCL)).
Η οθόνη διαθέτει συνήθως 32 κουτάκια (καθε ένα μπορεί να εκτυπώσει 1 γράμμα, 1 νούμερο, 1 σύμβολο, κτλ) τα οποία χωρίζονται σε 16 στήλες (0 - 15) και 2 γραμμές (0 - 1).
...
Ας δούμε την σύνδεση σε schematics:
